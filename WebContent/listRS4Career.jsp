...
System.out.print("   >> clms : " + columns[i] + " " + columnTypes[i]+ "\n");	
	  ...
	  %>
       <%
		...
		out.print("<form action=\"deleteManager.jsp\" name=form1 method=post>");
	    out.print("<table align=center valign=top border=1 cellpadding=8 cellspacing=0 bordercolor=#999999>");
 ...
 // System.out.print("   >> col value : " + (obj) + "\n");
 					if(((String)columns[i]).equals("mno"))
 					{
 						j = (Integer)obj;
 					}
				...
				out.print("<td><input type=\"checkbox\" name=\"manager\" value=\""+j+"\"</td>");
				out.print("</tr>");
			}
      %>
	  </table >
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type="submit" value="삭제 " name="a">
  </BODY>
</HTML>
