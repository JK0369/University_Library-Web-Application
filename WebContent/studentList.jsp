...
<script>function buttonClick(){
	...
	<table width=100%>
			...
			<td colspan=3>
				<H5 align=center>
					<table width="90%" align=center valign=top border="1"
						...
						<tr align=center>
							<td><a href="studentList.jsp" >학생목록
							</a></td>
							<td><a href="eachDeptBorrow.jsp">학과 별 대출 현황
							</a></td>
							<td><a href="eachYearBorrow.jsp" >학년 별 대출 현황
							</a></td>
							<td><a href="readingKing.jsp" >독서왕 리스트
							</a></td>						
							<td> <input type="button" value="학년갱신" onclick="buttonClick();"></td>
						</tr>
					</table>
				</H5>
		</tr>
		...
		<tr width=100% height=700>
		    <td colspan=3>    			
					<iframe width=100% height=700 src=resultAllStudents.jsp name=iframeContent seamless="seamless">					
	        </td>
	    <tr>
	</table>
</BODY>
