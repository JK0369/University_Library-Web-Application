...
<BODY>
	...
	<table width=100%>
			...
			<td colspan=3>
				<H5 align=center>
					<table width="90%" align=center valign=top border="1"
						...
						<tr align=center>
							<td><a href="aboutStudents.jsp" >학생정보
							</a></td>
							<td><a href="aboutManager.jsp">관리자 정보 목록
							</a></td>						
						</tr>
					</table>
				</H5>
		...
		<tr width=100% height=700>
		    <td colspan=3>				
					<iframe width=100% height=700 src=resultManagerList.jsp allowTransparency="true" name=iframeContent seamless="seamless">					
	        </td>
	    <tr>
	</table>
</BODY>
