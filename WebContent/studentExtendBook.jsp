...
<BODY>
	...
	<table width=100%>
			...
			<td colspan=3>
				<H5 align=center>
					<table width="90%" align=center valign=top border="1"
						...
						<tr align=center>
							<td><a href="studentSearchBookList.jsp">도서 검색
							</a></td>
							<td><a href="studentExtendBook.jsp">도서 연장 
							</a></td>
							<td><a href="listHistory.jsp"> 대출했던 도서 목록
							</a></td>				
						</tr>
					</table>
				</H5>
		...
		<tr width=100% height=700>
		    <td colspan=3>				
					<iframe width=100% height=700 src=showBorrowList.jsp name=iframeContent seamless="seamless">					
	        </td>
	    <tr>
	</table>
</BODY>
